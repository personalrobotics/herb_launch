...
# TODO make herb0's hostname actually .personalrobotics.ri.cmu.edu
if [ $(hostname) != 'herb0' ]
then
...
sleep 5s
pr_launcher "state_pub"    "state_publisher.launch configure_hands:=true right_hand:=bh280 left_hand:=no"
...
# ssh prdemo@herb2 /home/herb_home/shared/ros_ws/src/herb_launch/scripts/start_herb2.sh
